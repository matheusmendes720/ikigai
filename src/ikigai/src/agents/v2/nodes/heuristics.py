...
All logic is preserved (pure dict operations, no FORBIDDEN_FUNCTION names).
Phase 8.2 wires vault_read + ikigai_read_strategics as inputs.
"""
...
def heuristics_node(state: IKIGAiStateDict) -> dict[str, Any]:
    """Apply H1-H6 heuristics and emit corrections.
