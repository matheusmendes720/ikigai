...
M12 (T-13.3): ``mcp_bridge.ikigai_plan`` was deleted from
...
def plan_node(state: IKIGAiStateDict) -> dict[str, Any]:
    ...
    M12 removed ``mcp_bridge.ikigai_plan``. See module docstring.
    """
    return {
        "plan": None,
        "error_channel": [
            "mcp_bridge.ikigai_plan not available post-V5-E "
