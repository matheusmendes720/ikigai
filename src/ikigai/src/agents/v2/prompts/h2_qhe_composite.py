"""render_h2_qhe_composite — H2 Q_HE composite observation via LLM prompt.
...
## Tarefa
Estime o composite Q_HE (0.0-1.0) combinando hábitos e consistência.
Justifique em 2-3 frases em pt-BR.

Retorne JSON: {{"h2_qhe_composite": <float 0.0-1.0>, "rationale": "<pt-BR 2-3 sentences>"}}""",
)


def render_h2_qhe_composite(state: dict[str, Any]) -> dict[str, Any]:
    """Render H2 QHE composite observation via LLM (or deterministic stub in fake mode)."""
