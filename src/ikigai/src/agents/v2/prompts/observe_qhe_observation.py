"""render_observe_qhe_observation — Q_HE score observation via LLM prompt.
...
## Tarefa
Estime o score Q_HE (0.0-1.0) com base no ciclo atual.
Justifique em 2-3 frases em pt-BR.

Retorne JSON: {{"q_he": <float 0.0-1.0>, "rationale": "<pt-BR 2-3 sentences>"}}""",
)


def render_observe_qhe_observation(state: dict[str, Any]) -> dict[str, Any]:
    """Render Q_HE observation via LLM (or deterministic stub in fake mode)."""
