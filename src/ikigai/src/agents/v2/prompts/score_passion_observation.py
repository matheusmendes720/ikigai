"""render_score_passion_observation — passion vector (0-100) via LLM prompt.
...
## Tarefa
Estime a pontuação de paixão (0-100) com base no ciclo atual.
Justifique em 2-3 frases em pt-BR.

Retorne JSON: {{"passion_score": <int 0-100>, "rationale": "<pt-BR 2-3 sentences>"}}""",
)
