"""render_h6_severity — H6 severity observation via LLM prompt.
...
## Tarefa
Estime a severidade de infractions (0.0-1.0) com base no ciclo atual.
Justifique em 2-3 frases em pt-BR.

Retorne JSON: {{"h6_severity": <float 0.0-1.0>, "rationale": "<pt-BR 2-3 sentences>"}}""",
)
