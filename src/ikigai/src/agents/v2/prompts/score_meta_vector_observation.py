"""render_score_meta_vector_observation — meta-vector (0-100) via LLM prompt.
...
## Tarefa
Estime o meta-vetor (0-100) combinando as 5 dimensões IKIGAI.
Justifique em 2-3 frases em pt-BR.

Retorne JSON: {{"meta_vector_score": <int 0-100>, "rationale": "<pt-BR 2-3 sentences>"}}""",
)
