"""render_decompose_rice_observation — RICE decomposition observation via LLM prompt.
...
## Tarefa
Estime o score RICE (0.0-1.0) com base no ciclo atual.
Justifique em 2-3 frases em pt-BR.

Retorne JSON: {{"rice_score": <float 0.0-1.0>, "rationale": "<pt-BR 2-3 sentences>"}}""",
)
