...
**Generated:** 2026-06-22T16:19:11.018997+00:00  
...
| # | Command | Exit | Notes |
|---|---------|------|-------|
| lunch_01 | `pav lunch create --eat 45 --rest 20 --notas Test lunch via CLI s` | 0 | 'eat_min' not found in output |
| doctor_01 | `pav doctor --json` | 0 | 'schema_ok' not found in output |
| doctor_02 | `pav doctor` | 0 | 'schema_ok' not found in output |
...
| lunch_01 | lunch | `pav lunch create --eat 45 --rest 20 --n` | 0 | FAIL | eat_min | ╭──────────────────────── |
| lunch_02 | lunch | `pav lunch list --json` | 0 | PASS | id | id,date,eat_min,rest_min, |
| doctor_01 | doctor | `pav doctor --json` | 0 | FAIL | schema_ok | timestamp,checks,overall_ |
| doctor_02 | doctor | `pav doctor` | 0 | FAIL | schema_ok | ╭──────────────────────── |
